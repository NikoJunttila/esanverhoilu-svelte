...
<section class="{styles.paddings} relative z-10" id="showcase">
    <div class="{styles.innerWidth} mx-auto flex flex-col">
        ...
        <div class="relative mt-[50px]">
            ...
            <button
                onclick={() => scroll("left")}
                class="absolute left-0 top-1/2 -translate-y-1/2 z-20 p-3 rounded-full bg-primary-dark/80 text-white hover:bg-accent-gold hover:text-white transition-all duration-300 -ml-4 lg:-ml-12 hidden md:block border border-white/10"
            ...
            <button
                ...
                class="absolute right-0 top-1/2 -translate-y-1/2 z-20 p-3 rounded-full bg-primary-dark/80 text-white hover:bg-accent-gold hover:text-white transition-all duration-300 -mr-4 lg:-mr-12 hidden md:block border border-white/10"
            ...
            >
                {#each exploreWorlds as world, index}
                    <div
                        class="min-w-[300px] md:min-w-[400px] h-[500px] snap-center"
                    >
                        <ShowcaseCard
                            {...world}
                            {index}
