    ...
    {#if show}
        ...
        >
            ...
            >
                ...
                <button
                    onclick={toggleMenu}
                    class="lg:hidden z-50 relative w-[24px] h-[24px] flex flex-col justify-center items-center gap-1.5"
                    aria-label="Menu"
                >
                    <span
                        class={`w-full h-[2px] bg-white transition-all duration-300 ${isMenuOpen ? "rotate-45 translate-y-2" : ""}`}
                    ></span>
                    <span
                        class={`w-full h-[2px] bg-white transition-all duration-300 ${isMenuOpen ? "opacity-0" : ""}`}
                    ></span>
                    <span
                        class={`w-full h-[2px] bg-white transition-all duration-300 ${isMenuOpen ? "-rotate-45 -translate-y-2" : ""}`}
                    ></span>
                ...
                {#if isMenuOpen}
                    <div
                        class="fixed inset-0 bg-[#121212] z-40 flex flex-col justify-center items-center gap-8 lg:hidden h-screen w-screen"
